...
const CrewSlider = ({ data }) => {

    return (
        <React.Fragment>
            <h1 className='text-white font-medium mb-2 2xxl:text-[24px] xl:text-[22px] lg:text-[17px] md:text-[17px] sm:text-[17px] ms:text-[20px] lg:pl-10 md:pl-10 sm:pl-4 ms:pl-2'>
                Crew
            </h1>
            <ScrollSlider
                id={0}
