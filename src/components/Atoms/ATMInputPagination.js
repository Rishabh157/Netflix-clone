...
const ATMInputPagination = ({ totalPages, currentPage, onChange }) => {
    ...
    return (
        <div className='flex justify-center '>
            <div className='w-[3.5%] relative'>
                ...
                <div className={`absolute z-50 -right-24 -top-7 bg-black px-2 rounded transition-all ${isHover ? 'opacity-100' : 'opacity-0'}`}>
