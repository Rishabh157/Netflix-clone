...
const TrailerPlayModel = ({ show, url, autoplay = 1, controls = 1, onClose, className }) => {
    ...
    return (
        <div className={twMerge(`${show ? 'opacity-100 overlay' : 'opacity-0 invisible transition-all'}`, className)}>
            <div className='bg-black border-black border-[1px] rounded fixed z-50 2xxl:h-[80vh] 2xl:h-[80vh] xl:h-[90vh] lg:h-[96vh] md:h-[94vh] sm:h-[94vh] ms:h-[50vh] 
                ...
                <div className='h-full w-full'>
                    {show && <iframe
                        className='w-full h-full' //2xxl:h-[900px] 2xl:h-[700px] xl:h-[530px] lg:h-[670px] md:h-[600px] sm:h-[490px] ms:h-[300px]
